    ...
    <div class="menu-top">
      ...
      <nav class="menu-left">
        <button class="button-user">
          ...
          <i id="angle-icon" class="pi pi-sign-out logout" v-on:click="toggleLogout()"></i>
        </button>
      </nav>
    </div>
    <router-view>
            ...
            <div class="modal2" ref="modal2">
              <div class="not3-box">
                ...
                <div class="Boxes" >
                  ...
                  <div class="btns">
                    <Button class="btn-accept" @click="OpenModal3 = true">
                      <div class="txt-acc">Accept</div>
                    </Button>
                    <Button class="btn-decline" @click="OpenModal4 = true">
                      <div class="txt-dec">Decline</div>
                    </Button>
            ...
            <div class="box-complete-contract-accepted">
              <div class="not3-box">
                ...
                <div class="Boxes" v-for="product in recent_orders.slice(1, 2)" :key="product.id">
                  ...
                  <div class="btns">
                    <Button class="btn-accept2" @click="OpenModalContractAccepted = false">
                      <div class="txt-acc">Accept</div>
                    </Button>
                  </div>
                </div>
        ...
        <div class="not-resume">
          ...
          <div v-if="OpenModalContractRejected" class="modalContractRejected-bg">
            <div class="modalContractRejected" ref="modalContractRejected">
              ...
              <Button class="btn-accept-rejected" @click="OpenModalContractRejected = false">
                <div class="txt-acc">Accept</div>
              </Button>
...
export default {
  ...
  created() {
    ...
    this.homeUserApiService.getAvailable_Orders(localStorage.getItem("id")).then((response) => {
